...
// Stand: 2025-07-22_12:00:00, Codezeilen: ~115 (ReorderableTestUI Button hinzugefuegt, basierend auf Ihrer Datei)
...
fun HomeScreen(
    ...
    Column(
        ...
        // NEU: Button zum Aufrufen der ReorderableTestUI
        Button(
            onClick = { navController.navigate(Screen.ReorderableTest.route) }, // Verwendet Screen.ReorderableTest.route
            modifier = Modifier.padding(top = 8.dp)
        ) {
            Text("Reorderable Test-UI starten")
        }
