...
// Stand: 2025-07-28_12:35:00, Codezeilen: ~690 (Migrationslogik korrigiert: update statt insert/replace)
    ...
    override suspend fun migriereAnonymeArtikel(neuerBenutzerId: String) {
        ...
        try {
            ...
            anonymeArtikel.forEach { artikel ->
                ...
                // WICHTIG: Verwende artikelAktualisieren, da es sich um einen bestehenden Artikel handelt
                artikelDao.artikelAktualisieren(aktualisierterArtikel)
