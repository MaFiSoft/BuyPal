...
// Stand: 2025-07-28_12:35:00, Codezeilen: ~920 (Migrationslogik korrigiert: update statt insert/replace)
    ...
    override suspend fun migriereAnonymeEinkaufslisten(neuerBenutzerId: String) {
        ...
        try {
            ...
            anonymeEinkaufslisten.forEach { einkaufsliste ->
                ...
                // WICHTIG: Verwende einkaufslisteAktualisieren, da es sich um eine bestehende Einkaufsliste handelt
                einkaufslisteDao.einkaufslisteAktualisieren(aktualisierteEinkaufsliste)
        ...
        return try {
            ...
            if (transactionResult != null) {
                ...
                if (isFirestoreNewer || localEinkaufsliste?.istLokalGeaendert == false) {
                    ...
                    einkaufslisteDao.einkaufslisteEinfuegen(einkaufslisteToSaveLocally)
                    Timber.d("$TAG: einkaufslisteVerlassen: Einkaufsliste ${einkaufslisteToSaveLocally.name} (ID: ${einkaufslisteToSaveLocally.einkaufslisteId}) lokal nach Verlassen durch Benutzer aktualisiert.")
                } else {
