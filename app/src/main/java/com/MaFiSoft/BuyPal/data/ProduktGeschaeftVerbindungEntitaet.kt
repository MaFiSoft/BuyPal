...
// Stand: 2025-07-27_21:30:00, Codezeilen: ~35 (onDelete von CASCADE auf RESTRICT für GeschaeftEntitaet geändert)
...
@Entity(
    ...
    foreignKeys = [
        ...
        ForeignKey(
            ...
            onDelete = ForeignKey.RESTRICT // ÄNDERUNG: Verhindert Löschen des Geschäfts, wenn Verbindungen existieren
        )
    ],
    indices = [
