...
// Stand: 2025-07-23_16:30:00, Codezeilen: ~65 (Hinzugefuegt: updateGeschaeftFlags)
...
interface GeschaeftDao {
    ...
    /**
     * Ruft alle Geschaefte ab, die nicht zur Loeschung vorgemerkt sind.
     * @return Ein Flow, der eine Liste von Geschaeft-Entitaeten emittiert.
     */
    @Query("SELECT * FROM geschaeft WHERE istLoeschungVorgemerkt = 0")
    fun getAllGeschaefte(): Flow<List<GeschaeftEntitaet>>

    /**
     * Ruft alle Geschaefte ab, einschliesslich derer, die zur Loeschung vorgemerkt sind.
     * @return Eine Liste von Geschaeft-Entitaeten.
     */
    ...
    /**
     * Loescht ein Geschaeft anhand seiner eindeutigen ID aus der Datenbank.
     * Dies wird typischerweise nach erfolgreicher Cloud-Synchronisation aufgerufen oder fuer private Loeschungen.
     * @param geschaeftId Die ID des endgueltig zu loeschenden Geschaefts.
     */
     ...
     */
    @Query("UPDATE geschaeft SET istLokalGeaendert = :istLokalGeaendert, istLoeschungVorgemerkt = :istLoeschungVorgemerkt WHERE geschaeftId = :geschaeftId")
    suspend fun updateGeschaeftFlags(geschaeftId: String, istLokalGeaendert: Boolean, istLoeschungVorgemerkt: Boolean)
}
//// app/src/main/java/com/MaFiSoft/BuyPal/data/GeschaeftDao.kt
